...
- Generated at: 2026-04-19T14:04:56.266702+08:00
- Snapshot run stamp: 2026-04-19T14-04-56+0800
...
- snapshot 对齐：aligned_with_next_actions=True, run_stamp=2026-04-19T14-04-56+0800
...
- Priority: medium
- Reason: The surface consistency is not healthy: attention-needed.
- Suggested action: Refresh report, retro, status, and snapshot together until the visibility surfaces become consistent.

## Candidates
1. script `~/.hermes/scripts/hermes_self_evolution_report.py` [medium]
   - reason: The surface consistency is not healthy: attention-needed.
   - suggested_action: Refresh report, retro, status, and snapshot together until the visibility surfaces become consistent.
