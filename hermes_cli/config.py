...
OPTIONAL_ENV_VARS = {
    ...
    "PERPLEXITY_API_KEY": {
        "description": "Perplexity API key for real-time web search with ranked results",
    ...
    "PERPLEXITY_API_URL": {
        "description": "Perplexity API base URL for self-hosted or proxy deployments (optional, defaults to https://api.perplexity.ai)",
        "prompt": "Perplexity API URL (leave empty for default)",
        "url": None,
        "tools": ["web_search"],
        "password": False,
        "category": "tool",
...
def set_config_value(key: str, value: str):
    ...
    api_keys = [
        ...
        'TOOL_GATEWAY_USER_TOKEN', 'TAVILY_API_KEY', 'PERPLEXITY_API_KEY', 'PERPLEXITY_API_URL',
