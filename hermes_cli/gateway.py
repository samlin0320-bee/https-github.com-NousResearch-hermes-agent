...
_PLATFORMS = [
    ...
    },
    {
        ...
        "setup_instructions": [
            ...
            "5. Create Slash Command: Features → Slash Commands → Create New Command",
            "   • Command: /hermes",
            "   • Request URL: (can be empty for Socket Mode)",
            "   • Short Description: Hermes agent commands",
            "6. Install to Workspace: Settings → Install App → copy xoxb-... token",
            "7. Reinstall the app after any scope or event changes",
            "8. Find your user ID: click your profile → three dots → Copy member ID",
            "9. Invite the bot to channels: /invite @YourBot",
        ],
        "vars": [
