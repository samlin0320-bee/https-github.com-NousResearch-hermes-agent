...
"""
    ...
    cron_create.add_argument("--interpreter", help="Optional Python interpreter/executable for the pre-run script")
    ...
    cron_edit.add_argument("--interpreter", help="Optional Python interpreter/executable for the pre-run script. Pass empty string to clear.")
