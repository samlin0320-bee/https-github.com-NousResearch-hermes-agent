...
def select_provider_and_model(args=None):
    ...
    extended_providers = [
        ...
        ("stepfun", "StepFun Coding Plan (agent/coding models via Step Plan)"),
...
"""
    ...
    chat_parser.add_argument(
        "--provider",
        choices=["auto", "openrouter", "nous", "openai-codex", "copilot-acp", "copilot", "anthropic", "gemini", "huggingface", "zai", "kimi-coding", "stepfun", "minimax", "minimax-cn", "kilocode"],
        default=None,
