...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("insights", "Show usage insights and analytics", "Info",
               args_hint="[days]"),
    CommandDef("lineage", "Show which agent goal caused a file to be written", "Info",
               cli_only=True, args_hint="<file-path>"),
    CommandDef("costmap", "Show per-task token cost breakdown for this session", "Info",
               cli_only=True),
