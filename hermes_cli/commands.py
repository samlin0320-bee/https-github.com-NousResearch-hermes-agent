...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("receipts", "Manage execution receipts — list, query, prune, reconcile", "Tools & Skills",
               cli_only=True, args_hint="[subcommand]",
               subcommands=("list", "get", "query", "prune", "reconcile", "status", "install", "remove")),
    CommandDef("workorders", "Manage durable H007 execution work orders", "Tools & Skills",
               cli_only=True, args_hint="[subcommand]",
               subcommands=("list", "enqueue", "run", "reclaim", "retry", "resume", "cancel", "status", "install", "remove")),
