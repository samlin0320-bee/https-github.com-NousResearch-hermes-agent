...
def _print_setup_summary(config: dict, hermes_home):
    ...
    # Firecrawl / SearchHive (web tools)
    if get_env_value("FIRECRAWL_API_KEY") or get_env_value("FIRECRAWL_API_URL") or get_env_value("SEARCHHIVE_API_KEY"):
        tool_status.append(("Web Search & Extract", True, None))
    else:
        tool_status.append(("Web Search & Extract", False, "FIRECRAWL_API_KEY or SEARCHHIVE_API_KEY"))
