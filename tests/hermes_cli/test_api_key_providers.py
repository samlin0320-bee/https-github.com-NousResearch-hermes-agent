...
PROVIDER_ENV_VARS = (
    ...
    "XAI_API_KEY", "XAI_BASE_URL", "HF_TOKEN", "HF_BASE_URL", "XIAOMI_API_KEY", "XIAOMI_BASE_URL",
    "OPENCODE_ZEN_API_KEY", "OPENCODE_ZEN_BASE_URL", "OPENCODE_GO_API_KEY", "OPENCODE_GO_BASE_URL",
