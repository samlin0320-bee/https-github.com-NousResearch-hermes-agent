...
description: "Chat with Hermes from Telegram, Discord, Slack, WhatsApp, Signal, Session, SMS, Email, Home Assistant, Mattermost, Matrix, DingTalk, Webhooks, or any OpenAI-compatible frontend via the API server — architecture and setup overview"
---
